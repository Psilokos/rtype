 ...
 * @Date: 2016-12-24 12:39:44 
 * @Last Modified by: Stephane.Lejeune
 * @Last Modified time: 2016-12-24 12:49:33
 */
 
#include "Animation.hpp"

Animation::Animation(sf::Time frameTime, bool paused, bool looped) :
    m_animation(NULL), m_frameTime(frameTime), m_currentFrame(0), m_isPaused(paused), m_isLooped(looped), m_texture(NULL)
{}

void Animation::setAnimation(const Animation& animation)
{
...
void Animation::play(const Animation& animation)
{
...
const Animation* Animation::getAnimation() const
{
    return m_animation;
}
...
void Animation::setFrame(std::size_t newFrame, bool resetTime)
{
    if (m_animation)
    {
